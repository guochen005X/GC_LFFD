...
class GetMiniBatch:
    ...
    def PrepareMinibatch(self):
        ...
        # [(batch_size, 6, 59, 59), (batch_size, 32, 6, 29, 29),
        # (batch_size,, 6, 14, 14), (batch_size, 32, 6, 6, 6)]
        ...
        while loop < self.batch_size:
            ...
            if loop < self.num_neg_images_per_batch:
                ...
                bboxes_org = self.data_batch[rand_idx][1:5]
        ...
        data_batch_label = []
        for n in range(self.num_output_scales):
            data_batch_mask.append_label(mask_batch_list[n])
            data_batch_label.append_label(label_batch_list[n])
